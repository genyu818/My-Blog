...
- 工作过程
  ...
  - 具体工作过程
    ...
    ![image-20211124222351883](D:\Blog\My-Blog\pic\image-20211124222351883.png)
...
![image-20211124222501868](D:\Blog\My-Blog\pic\image-20211124222501868.png)
...
![image-20211124222602412](D:\Blog\My-Blog\pic\image-20211124222602412.png)

## 3.	解释器

JVM设计者们的初衷仅仅只是单纯地为了==满足Java程序实现跨平台特性==，因此避免采用静态编译的方式直接生成本地机器指令，从而诞生了实现解释器在运行时采用逐行解释字节码执行程序的想法。

![image-20211124222656248](D:\Blog\My-Blog\pic\image-20211124222656248.png)
...
![image-20211124223022648](D:\Blog\My-Blog\pic\image-20211124223022648.png)

##### 回边计数器

它的作用是统计一个方法中循环体代码执行的次数，在字节码中遇到控制流向后跳转的指令称为“回边” （Back Edge）。显然，建立回边计数器统计的目的就是为了触发OSR编译。

![image-20211124223054520](D:\Blog\My-Blog\pic\image-20211124223054520.png)
