...
![image-20220118210831950](D:\Blog\My-Blog\pic\image-20220118210831950.png)

#### 串行（Serial）

相较于并行的概念，单线程执行。如果内存不够，则程序暂停，启动JM垃圾回收器进行垃圾回收。回收完，再启动程序的线程。

![image-20220118210844797](D:\Blog\My-Blog\pic\image-20220118210844797.png)

#### 并发(Concurrent)

GC线程与应用程序线程交替工作，以尽可能减少应用程序的停顿时间

![image-20220118210945684](D:\Blog\My-Blog\pic\image-20220118210945684.png)
